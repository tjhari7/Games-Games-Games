...
export default function GameDetails() {
  ...
  // Nothing but the header until the data is in: showLoader covers the wait,
  // and the short gap before it is deliberately blank so a fast load doesn't
  // flash a spinner. See lib/useLoaderGate.js.
  if (!contentReady) {
    return (
      <div className="page">
  ...
  return (
    <div className="page">
      ...
      {/* Same bar as the random-draw and card-view pages — one "actions on a
          game" treatment, wherever a game is being looked at. */}
